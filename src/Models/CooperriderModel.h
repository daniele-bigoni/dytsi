...
/* 
 * File:   CooperriderWagon.h
 * Author: s083781
 *
 * Created on February 14, 2011, 9:26 AM
 */

#ifndef COOPERRIDERMODEL_H
#define	COOPERRIDERMODEL_H
...
namespace DYTSI_Models {
    class CooperriderModel : public DYTSI_Modelling::GeneralModel {
    public:
        CooperriderModel();
        virtual ~CooperriderModel();
