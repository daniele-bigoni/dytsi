...
namespace DYTSI_Models {
    ...
    CooperriderOrthogonalFixedModel::CooperriderOrthogonalFixedModel()
    ...
    std::vector<DYTSI_Modelling::Component*> CooperriderOrthogonalFixedModel::getComponentList(){
    ...
    bool CooperriderOrthogonalFixedModel::loadProperties(XERCES_CPP_NAMESPACE::DOMElement* el){
        bool errCode = false;
    ...
    bool CooperriderOrthogonalFixedModel::loadStartingValues(XERCES_CPP_NAMESPACE::DOMElement* el, std::vector<double>& startingValues){
        bool error = false;
    ...
    bool CooperriderOrthogonalFixedModel::setupModel( XERCES_CPP_NAMESPACE::DOMElement* el ){
    ...
    double CooperriderOrthogonalFixedModel::getD1() const {
        return D1;
    }

    void CooperriderOrthogonalFixedModel::setD1(double D1) {
        this->D1 = D1;
    }

    double CooperriderOrthogonalFixedModel::getD2() const {
        return D2;
    }

    void CooperriderOrthogonalFixedModel::setD2(double D2) {
        this->D2 = D2;
    }

    double CooperriderOrthogonalFixedModel::getD3() const {
        return D3;
    }

    void CooperriderOrthogonalFixedModel::setD3(double D3) {
        this->D3 = D3;
    }

    double CooperriderOrthogonalFixedModel::getD4() const {
        return D4;
    }

    void CooperriderOrthogonalFixedModel::setD4(double D4) {
        this->D4 = D4;
    }

    double CooperriderOrthogonalFixedModel::getD5() const {
        return D5;
    }

    void CooperriderOrthogonalFixedModel::setD5(double D5) {
        this->D5 = D5;
    }

    double CooperriderOrthogonalFixedModel::getD6() const {
        return D6;
    }

    void CooperriderOrthogonalFixedModel::setD6(double D6) {
        this->D6 = D6;
    }

    double CooperriderOrthogonalFixedModel::getK1() const {
        return k1;
    }

    void CooperriderOrthogonalFixedModel::setK1(double k1) {
        this->k1 = k1;
    }

    double CooperriderOrthogonalFixedModel::getK2() const {
        return k2;
    }

    void CooperriderOrthogonalFixedModel::setK2(double k2) {
        this->k2 = k2;
    }

    double CooperriderOrthogonalFixedModel::getK3() const {
        return k3;
    }

    void CooperriderOrthogonalFixedModel::setK3(double k3) {
        this->k3 = k3;
    }

    double CooperriderOrthogonalFixedModel::getK4() const {
        return k4;
    }

    void CooperriderOrthogonalFixedModel::setK4(double k4) {
        this->k4 = k4;
    }

    double CooperriderOrthogonalFixedModel::getK5() const {
        return k5;
    }

    void CooperriderOrthogonalFixedModel::setK5(double k5) {
        this->k5 = k5;
    }

    double CooperriderOrthogonalFixedModel::getK6() const {
        return k6;
    }

    void CooperriderOrthogonalFixedModel::setK6(double k6) {
        this->k6 = k6;
    }

    double CooperriderOrthogonalFixedModel::getH1() const {
        return h1;
    }

    void CooperriderOrthogonalFixedModel::setH1(double h1) {
        this->h1 = h1;
    }

    double CooperriderOrthogonalFixedModel::getH2() const {
        return h2;
    }

    void CooperriderOrthogonalFixedModel::setH2(double h2) {
        this->h2 = h2;
    }

    double CooperriderOrthogonalFixedModel::getR0() const {
        return r0;
    }

    void CooperriderOrthogonalFixedModel::setR0(double r0) {
        this->r0 = r0;
    }

    double CooperriderOrthogonalFixedModel::getA() const {
        return a;
    }

    void CooperriderOrthogonalFixedModel::setA(double a) {
        this->a = a;
    }

    void CooperriderOrthogonalFixedModel::setL1(double val){
        this->l1 = val;
    }

    void CooperriderOrthogonalFixedModel::setL2(double val){
        this->l2 = val;
    }

    void CooperriderOrthogonalFixedModel::setL3(double val){
        this->l3 = val;
    }

    void CooperriderOrthogonalFixedModel::setV1(double val){
        this->v1 = val;
    }

    void CooperriderOrthogonalFixedModel::setV2(double val){
        this->v2 = val;
    }

    void CooperriderOrthogonalFixedModel::setV3(double val){
        this->v3 = val;
    }

    void CooperriderOrthogonalFixedModel::setV4(double val){
        this->v4 = val;
    }

    void CooperriderOrthogonalFixedModel::setU1(double val){
        this->u1 = val;
    }

    void CooperriderOrthogonalFixedModel::setU2(double val){
        this->u2 = val;
    }

    void CooperriderOrthogonalFixedModel::setX1(double val){
        this->x1 = val;
    }

    void CooperriderOrthogonalFixedModel::setS1(double val){
        this->s1 = val;
    }

    void CooperriderOrthogonalFixedModel::setS2(double val){
        this->s2 = val;
    }

    void CooperriderOrthogonalFixedModel::setS3(double val){
        this->s3 = val;
    }

    void CooperriderOrthogonalFixedModel::setS4(double val){
        this->s4 = val;
    }

    double CooperriderOrthogonalFixedModel::getL1() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getL2() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getL3() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getV1() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getV2() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getV3() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getV4() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getU1() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getU2() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getX1() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getS1() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getS2() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getS3() const{
        return this->l1;
    }

    double CooperriderOrthogonalFixedModel::getS4() const{
        return this->l1;
    }

    XERCES_CPP_NAMESPACE::DOMNode* CooperriderOrthogonalFixedModel::getRSGEO_path() const {
        return this->pathRSGEO;
    }

    void CooperriderOrthogonalFixedModel::setRSGEO_path(XERCES_CPP_NAMESPACE::DOMNode* RSGEO_Path){
