...
#ifndef COOPERRIDERORTHOGONALFIXEDMODEL_H
#define	COOPERRIDERORTHOGONALFIXEDMODEL_H
...
namespace DYTSI_Models {
    class CooperriderOrthogonalFixedModel : public DYTSI_Modelling::GeneralModel {
    public:
        CooperriderOrthogonalFixedModel();
        virtual ~CooperriderOrthogonalFixedModel();
...
#endif	/* COOPERRIDERORTHOGONALFIXEDMODEL_H */
