...
#ifndef COOPERRIDERORTHOGONALASYMMETRICMODEL_H
#define COOPERRIDERORTHOGONALASYMMETRICMODEL_H
...
namespace DYTSI_Models {
	class CooperriderOrthogonalAsymmetricModel: public DYTSI_Modelling::GeneralModel {
	public:
		CooperriderOrthogonalAsymmetricModel();
		virtual ~CooperriderOrthogonalAsymmetricModel();
...
#endif /* COOPERRIDERORTHOGONALASYMMETRICMODEL_H */
