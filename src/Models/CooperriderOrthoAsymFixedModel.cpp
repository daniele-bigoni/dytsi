...
/*
 * CooperriderOrthoAsymFixedModel.cpp
 *
...
namespace DYTSI_Models {
    ...
    CooperriderOrthoAsymFixedModel::CooperriderOrthoAsymFixedModel()
    ...
    std::vector<DYTSI_Modelling::Component*> CooperriderOrthoAsymFixedModel::getComponentList(){
    ...
    bool CooperriderOrthoAsymFixedModel::loadProperties(XERCES_CPP_NAMESPACE::DOMElement* el){
		bool errCode = false;
    ...
    bool CooperriderOrthoAsymFixedModel::loadStartingValues(XERCES_CPP_NAMESPACE::DOMElement* el, std::vector<double>& startingValues){
        bool error = false;
    ...
    bool CooperriderOrthoAsymFixedModel::setupModel( XERCES_CPP_NAMESPACE::DOMElement* el ){
        ...
        // Setup the Bogieframes, the connection and add them to the model
        {
            ...
            leadingBogieFrame = new DYTSI_Modelling::BogieFrameComponent(
                    ...
                    "Leading Bogie Frame", this, L_isFixed );
            ...
            trailingBogieFrame = new DYTSI_Modelling::BogieFrameComponent(
                    ...
                    mass, Ix, Iy, Iz, u2,
                    this->getExternalComponents(),
                    "Trailing Bogie Frame", this, T_isFixed);
        ...
        // Set up the wheelsets and connect them to the bogie frames
        {
            ...
            bool LL_isFixed = false;
            bool LT_isFixed = false;
            bool TL_isFixed = true;
            bool TT_isFixed = true;
            ...
            // Leading Bogie Frame - Leading wheelset
            {
                ...
                llwheelset = new DYTSI_Modelling::WheelSetComponent(
                        ...
                        this->getExternalComponents(),
                        rsgeo_table,
                        "Leading Bogie - Leading Wheelset", this, LL_isFixed);
            };
            ...
            // Leading Bogie Frame - Trailing wheelset
            {
                ...
                ltwheelset = new DYTSI_Modelling::WheelSetComponent(
                        ...
                        this->getExternalComponents(),
                        rsgeo_table,
                        "Leading Bogie - Trailing Wheelset", this, LT_isFixed);
            };
            ...
            // Trailing Bogie Frame - Leading wheelset
            {
                ...
                tlwheelset = new DYTSI_Modelling::WheelSetComponent(
                        ...
                        this->getExternalComponents(),
                        rsgeo_table,
                        "Trailing Bogie - Leading Wheelset", this, TL_isFixed);
            };
            ...
            // Trailing Bogie Frame - Trailing wheelset
            {
                ...
                ttwheelset = new DYTSI_Modelling::WheelSetComponent(
                        ...
                        this->getExternalComponents(),
                        rsgeo_table,
                        "Trailing Bogie - Trailing Wheelset", this, TT_isFixed);
            };
    ...
    double CooperriderOrthoAsymFixedModel::get_PSLL_LEFT_K1() const {
        return this->PSLL_LEFT_K1;
    }

    double CooperriderOrthoAsymFixedModel::get_PSLL_LEFT_K2() const {
		return this->PSLL_LEFT_K2;
	}

    double CooperriderOrthoAsymFixedModel::get_PSLL_LEFT_K3() const {
		return this->PSLL_LEFT_K3;
	}

    double CooperriderOrthoAsymFixedModel::get_PSLL_RIGHT_K1() const {
		return this->PSLL_RIGHT_K1;
	}

	double CooperriderOrthoAsymFixedModel::get_PSLL_RIGHT_K2() const {
		return this->PSLL_RIGHT_K2;
	}

	double CooperriderOrthoAsymFixedModel::get_PSLL_RIGHT_K3() const {
		return this->PSLL_RIGHT_K3;
	}

	double CooperriderOrthoAsymFixedModel::get_PSLT_LEFT_K1() const {
		return this->PSLT_LEFT_K1;
	}

	double CooperriderOrthoAsymFixedModel::get_PSLT_LEFT_K2() const {
		return this->PSLT_LEFT_K2;
	}

	double CooperriderOrthoAsymFixedModel::get_PSLT_LEFT_K3() const {
		return this->PSLT_LEFT_K3;
	}

	double CooperriderOrthoAsymFixedModel::get_PSLT_RIGHT_K1() const {
		return this->PSLT_RIGHT_K1;
	}

	double CooperriderOrthoAsymFixedModel::get_PSLT_RIGHT_K2() const {
		return this->PSLT_RIGHT_K2;
	}

	double CooperriderOrthoAsymFixedModel::get_PSLT_RIGHT_K3() const {
		return this->PSLT_RIGHT_K3;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTL_LEFT_K1() const {
		return this->PSTL_LEFT_K1;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTL_LEFT_K2() const {
		return this->PSTL_LEFT_K2;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTL_LEFT_K3() const {
		return this->PSTL_LEFT_K3;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTL_RIGHT_K1() const {
		return this->PSTL_RIGHT_K1;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTL_RIGHT_K2() const {
		return this->PSTL_RIGHT_K2;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTL_RIGHT_K3() const {
		return this->PSTL_RIGHT_K3;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTT_LEFT_K1() const {
		return this->PSTT_LEFT_K1;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTT_LEFT_K2() const {
		return this->PSTT_LEFT_K2;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTT_LEFT_K3() const {
		return this->PSTT_LEFT_K3;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTT_RIGHT_K1() const {
		return this->PSTT_RIGHT_K1;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTT_RIGHT_K2() const {
		return this->PSTT_RIGHT_K2;
	}

	double CooperriderOrthoAsymFixedModel::get_PSTT_RIGHT_K3() const {
		return this->PSTT_RIGHT_K3;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_LEFT_K4() const {
		return this->SSL_LEFT_K4;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_LEFT_K5() const {
		return this->SSL_LEFT_K5;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_LEFT_K6() const {
		return this->SSL_LEFT_K6;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_LEFT_D1() const {
		return this->SSL_LEFT_D1;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_LEFT_D2() const {
		return this->SSL_LEFT_D2;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_LEFT_D6() const {
		return this->SSL_LEFT_D6;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_RIGHT_K4() const {
		return this->SSL_RIGHT_K4;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_RIGHT_K5() const {
		return this->SSL_RIGHT_K5;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_RIGHT_K6() const {
		return this->SSL_RIGHT_K6;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_RIGHT_D1() const {
		return this->SSL_RIGHT_D1;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_RIGHT_D2() const {
		return this->SSL_RIGHT_D2;
	}

	double CooperriderOrthoAsymFixedModel::get_SSL_RIGHT_D6() const {
		return this->SSL_RIGHT_D6;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_LEFT_K4() const {
		return this->SST_LEFT_K4;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_LEFT_K5() const {
		return this->SST_LEFT_K5;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_LEFT_K6() const {
		return this->SST_LEFT_K6;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_LEFT_D1() const {
		return this->SST_LEFT_D1;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_LEFT_D2() const {
		return this->SST_LEFT_D2;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_LEFT_D6() const {
		return this->SST_LEFT_D6;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_RIGHT_K4() const {
		return this->SST_RIGHT_K4;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_RIGHT_K5() const {
		return this->SST_RIGHT_K5;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_RIGHT_K6() const {
		return this->SST_RIGHT_K6;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_RIGHT_D1() const {
		return this->SST_RIGHT_D1;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_RIGHT_D2() const {
		return this->SST_RIGHT_D2;
	}

	double CooperriderOrthoAsymFixedModel::get_SST_RIGHT_D6() const {
    ...
    void CooperriderOrthoAsymFixedModel::set_PSLL_LEFT_K1(double val)  {
        this->PSLL_LEFT_K1 = val;
    }

    void CooperriderOrthoAsymFixedModel::set_PSLL_LEFT_K2(double val)  {
		this->PSLL_LEFT_K2 = val;
	}

    void CooperriderOrthoAsymFixedModel::set_PSLL_LEFT_K3(double val)  {
		this->PSLL_LEFT_K3 = val;
	}

    void CooperriderOrthoAsymFixedModel::set_PSLL_RIGHT_K1(double val)  {
		this->PSLL_RIGHT_K1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSLL_RIGHT_K2(double val)  {
		this->PSLL_RIGHT_K2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSLL_RIGHT_K3(double val)  {
		this->PSLL_RIGHT_K3 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSLT_LEFT_K1(double val)  {
		this->PSLT_LEFT_K1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSLT_LEFT_K2(double val)  {
		this->PSLT_LEFT_K2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSLT_LEFT_K3(double val)  {
		this->PSLT_LEFT_K3 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSLT_RIGHT_K1(double val)  {
		this->PSLT_RIGHT_K1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSLT_RIGHT_K2(double val)  {
		this->PSLT_RIGHT_K2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSLT_RIGHT_K3(double val)  {
		this->PSLT_RIGHT_K3 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTL_LEFT_K1(double val)  {
		this->PSTL_LEFT_K1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTL_LEFT_K2(double val)  {
		this->PSTL_LEFT_K2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTL_LEFT_K3(double val)  {
		this->PSTL_LEFT_K3 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTL_RIGHT_K1(double val)  {
		this->PSTL_RIGHT_K1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTL_RIGHT_K2(double val)  {
		this->PSTL_RIGHT_K2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTL_RIGHT_K3(double val)  {
		this->PSTL_RIGHT_K3 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTT_LEFT_K1(double val)  {
		this->PSTT_LEFT_K1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTT_LEFT_K2(double val)  {
		this->PSTT_LEFT_K2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTT_LEFT_K3(double val)  {
		this->PSTT_LEFT_K3 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTT_RIGHT_K1(double val)  {
		this->PSTT_RIGHT_K1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTT_RIGHT_K2(double val)  {
		this->PSTT_RIGHT_K2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_PSTT_RIGHT_K3(double val)  {
		this->PSTT_RIGHT_K3 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_LEFT_K4(double val)  {
		this->SSL_LEFT_K4 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_LEFT_K5(double val)  {
		this->SSL_LEFT_K5 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_LEFT_K6(double val)  {
		this->SSL_LEFT_K6 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_LEFT_D1(double val)  {
		this->SSL_LEFT_D1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_LEFT_D2(double val)  {
		this->SSL_LEFT_D2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_LEFT_D6(double val)  {
		this->SSL_LEFT_D6 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_RIGHT_K4(double val)  {
		this->SSL_RIGHT_K4 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_RIGHT_K5(double val)  {
		this->SSL_RIGHT_K5 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_RIGHT_K6(double val)  {
		this->SSL_RIGHT_K6 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_RIGHT_D1(double val)  {
		this->SSL_RIGHT_D1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_RIGHT_D2(double val)  {
		this->SSL_RIGHT_D2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SSL_RIGHT_D6(double val)  {
		this->SSL_RIGHT_D6 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_LEFT_K4(double val)  {
		this->SST_LEFT_K4 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_LEFT_K5(double val)  {
		this->SST_LEFT_K5 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_LEFT_K6(double val)  {
		this->SST_LEFT_K6 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_LEFT_D1(double val)  {
		this->SST_LEFT_D1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_LEFT_D2(double val)  {
		this->SST_LEFT_D2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_LEFT_D6(double val)  {
		this->SST_LEFT_D6 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_RIGHT_K4(double val)  {
		this->SST_RIGHT_K4 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_RIGHT_K5(double val)  {
		this->SST_RIGHT_K5 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_RIGHT_K6(double val)  {
		this->SST_RIGHT_K6 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_RIGHT_D1(double val)  {
		this->SST_RIGHT_D1 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_RIGHT_D2(double val)  {
		this->SST_RIGHT_D2 = val;
	}

	void CooperriderOrthoAsymFixedModel::set_SST_RIGHT_D6(double val)  {
    ...
    double CooperriderOrthoAsymFixedModel::getH1() const {
        return h1;
    }

    void CooperriderOrthoAsymFixedModel::setH1(double h1) {
        this->h1 = h1;
    }

    double CooperriderOrthoAsymFixedModel::getH2() const {
        return h2;
    }

    void CooperriderOrthoAsymFixedModel::setH2(double h2) {
        this->h2 = h2;
    }

    double CooperriderOrthoAsymFixedModel::getR0() const {
        return r0;
    }

    void CooperriderOrthoAsymFixedModel::setR0(double r0) {
        this->r0 = r0;
    }

    double CooperriderOrthoAsymFixedModel::getA() const {
        return a;
    }

    void CooperriderOrthoAsymFixedModel::setA(double a) {
        this->a = a;
    }

    void CooperriderOrthoAsymFixedModel::setL1(double val){
        this->l1 = val;
    }

    void CooperriderOrthoAsymFixedModel::setL2(double val){
        this->l2 = val;
    }

    void CooperriderOrthoAsymFixedModel::setL3(double val){
        this->l3 = val;
    }

    void CooperriderOrthoAsymFixedModel::setV1(double val){
        this->v1 = val;
    }

    void CooperriderOrthoAsymFixedModel::setV2(double val){
        this->v2 = val;
    }

    void CooperriderOrthoAsymFixedModel::setV3(double val){
        this->v3 = val;
    }

    void CooperriderOrthoAsymFixedModel::setV4(double val){
        this->v4 = val;
    }

    void CooperriderOrthoAsymFixedModel::setU1(double val){
        this->u1 = val;
    }

    void CooperriderOrthoAsymFixedModel::setU2(double val){
        this->u2 = val;
    }

    void CooperriderOrthoAsymFixedModel::setX1(double val){
        this->x1 = val;
    }

    void CooperriderOrthoAsymFixedModel::setS1(double val){
        this->s1 = val;
    }

    void CooperriderOrthoAsymFixedModel::setS2(double val){
        this->s2 = val;
    }

    void CooperriderOrthoAsymFixedModel::setS3(double val){
        this->s3 = val;
    }

    void CooperriderOrthoAsymFixedModel::setS4(double val){
        this->s4 = val;
    }

    double CooperriderOrthoAsymFixedModel::getL1() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getL2() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getL3() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getV1() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getV2() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getV3() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getV4() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getU1() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getU2() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getX1() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getS1() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getS2() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getS3() const{
        return this->l1;
    }

    double CooperriderOrthoAsymFixedModel::getS4() const{
        return this->l1;
    }

    XERCES_CPP_NAMESPACE::DOMNode* CooperriderOrthoAsymFixedModel::getRSGEO_path() const {
        return this->pathRSGEO;
    }

    void CooperriderOrthoAsymFixedModel::setRSGEO_path(XERCES_CPP_NAMESPACE::DOMNode* RSGEO_Path){
