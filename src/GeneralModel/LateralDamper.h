...
/* 
 * File:   LateralDamper.h
 * Author: s083781
 *
 * Created on April 7, 2011, 1:39 PM
 */

#ifndef LATERALDAMPER_H
#define	LATERALDAMPER_H

#include "LinkDamper.h"

namespace DYTSI_Modelling {
    class LateralDamper : public LinkDamper{
    public:
        LateralDamper(std::string name, gsl_vector* connectionPointUp,
            gsl_vector* connectionPointDown, Function* dampingFunction);
        virtual ~LateralDamper();
