...
/* 
 * File:   LongitudinalDamper.h
 * Author: s083781
 *
 * Created on April 7, 2011, 3:42 PM
 */

#ifndef LONGITUDINALDAMPER_H
#define	LONGITUDINALDAMPER_H

#include "LinkDamper.h"

namespace DYTSI_Modelling {
    class LongitudinalDamper : public LinkDamper {
    public:
        LongitudinalDamper(std::string name, gsl_vector* connectionPointUp,
            gsl_vector* connectionPointDown, Function* dampingFunction);
        virtual ~LongitudinalDamper();
