...
/* 
 * File:   CarBodyComponent.h
 * Author: bigo
 *
 * Created on February 12, 2011, 4:56 PM
 */

#ifndef CARBODYCOMPONENT_H
#define	CARBODYCOMPONENT_H
...
namespace DYTSI_Modelling {
    ...
    public:
        CarBodyComponent( gsl_vector* centerOfGeometry,
    ...
    private:
        ...
        // Shortcuts
        BogieFrameCarBodyConnector* llConnector;
        BogieFrameCarBodyConnector* ltConnector;
        BogieFrameComponent* llComponent;
        BogieFrameComponent* ltComponent;
