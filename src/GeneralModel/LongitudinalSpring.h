...
/* 
 * File:   LongitudinalSpring.h
 * Author: s083781
 *
 * Created on April 7, 2011, 12:42 PM
 */

#ifndef LONGITUDINALSPRING_H
#define	LONGITUDINALSPRING_H

#include "LinkSpring.h"

namespace DYTSI_Modelling {
    class LongitudinalSpring : public LinkSpring {
    public:
        LongitudinalSpring(std::string name, gsl_vector* connectionPointUp,
            gsl_vector* connectionPointDown, Function* stiffnessFunction);
        virtual ~LongitudinalSpring();
